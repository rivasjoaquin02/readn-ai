...
const BookImage = ({
    ...
    return (
        <div className="relative transform-gpu transition-transform hover:-translate-y-1 hover:scale-105">
            <Link href={href}>
                <div
                    className="h-[280px] w-[200px] cursor-pointer bg-yellow-600 shadow-2xl shadow-gray-700"
                >
